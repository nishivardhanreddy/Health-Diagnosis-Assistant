...
def message():
    if Symptom1 == "None" and Symptom2 == "None" and Symptom3 == "None" and Symptom4 == "None" and Symptom5 == "None":
        st.warning("OPPS!! ENTER SYMPTOMS PLEASE")
    else:
        st.success("Symptoms selected. Running NaiveBayes...")
        NaiveBayes()
...
st.write("Please select up to 5 symptoms:")
...
if "predicted_disease" in st.session_state:
    if st.session_state.predicted_disease:
        st.success(f"The predicted disease is: {st.session_state.predicted_disease}")
    else:
